...
filename = "/storage/home1/e1-246-60/assignment2/dataset/austen-emma.txt"
...
#model = lstm(X,y)
#model.save('/home/clabuser/AAkash/NLU_A2/model_char.h5')

#loading the model
model = load_model('/storage/home1/e1-246-60/assignment2/model_char.h5')
